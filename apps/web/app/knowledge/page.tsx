...
export default function KnowledgePage() {
  ...
  return <main className="knowledge-page"><div className="knowledge-shell">
    <header className="knowledge-header"><span>Библиотека Mira</span><h1>Статьи</h1><p>Понятные материалы о цикле, самочувствии и сексуальном здоровье — спокойно и без осуждения.</p></header>

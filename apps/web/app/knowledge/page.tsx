...
export default function KnowledgePage() {
  ...
  return <main className="knowledge-page"><div className="knowledge-shell">
    ...
    <section className="featured-article"><div><small>Рекомендуем начать здесь</small><h2>Цикл — это больше, чем календарь</h2><p>Базовый материал о том, какие изменения происходят в течение цикла и зачем вести наблюдения.</p><Link href="/knowledge/cycle-basics-1">Читать статью <ArrowUpRight /></Link></div><div className="featured-art" aria-hidden="true"><span /><span /><BookHeart /></div></section>

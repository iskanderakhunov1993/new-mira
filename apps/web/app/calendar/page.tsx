  ...
  return (
    <main className="calendar-page">
      <div className="calendar-shell">
        ...
        <section className="calendar-legend-card" aria-label="Обозначения календаря">
          <div className="calendar-legend"><span><i className="actual" />Факт: месячные</span><span><i className="predicted" />Диапазон прогноза</span><span><i className="symptom" />Есть симптомы</span><span><i className="entry" />Есть отметка</span></div>
